export default function handler(req, res) {
  ...
  return res.status(200).json({
    ...
    auth: {
      ...
      ownership_auth_note:
        'Creator/moderator/session ownership checks prefer SIWE (EIP-4361) message signatures (no token transfer/approval). EIP-712 and legacy text are accepted for compatibility.',
      agent_key_boundary:
