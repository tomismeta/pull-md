...
export function setCors(res, origin) {
  ...
  res.setHeader(
    ...
    'Content-Type, PAYMENT-SIGNATURE, X-CLIENT-MODE, X-WALLET-ADDRESS, X-AUTH-SIGNATURE, X-AUTH-TIMESTAMP, X-PURCHASE-RECEIPT, X-REDOWNLOAD-SESSION, X-REVIEWER, X-MODERATOR-ADDRESS, X-MODERATOR-SIGNATURE, X-MODERATOR-TIMESTAMP'
  );
  res.setHeader(
