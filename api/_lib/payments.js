...
export function setCors(res, origin) {
  ...
  res.setHeader(
    ...
    'Content-Type, PAYMENT, PAYMENT-SIGNATURE, X-PAYMENT, X-WALLET-ADDRESS, X-AUTH-SIGNATURE, X-AUTH-TIMESTAMP, X-PURCHASE-RECEIPT, X-REVIEWER, X-MODERATOR-ADDRESS, X-MODERATOR-SIGNATURE, X-MODERATOR-TIMESTAMP'
  );
